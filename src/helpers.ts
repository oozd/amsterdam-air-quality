...
export const AMSTERDAM_CENTER_LAT_LNG = [52.377956, 4.89707];
...
export async function getStationFeeds(stations): Promise<any> {
...
export function iconGenerator(pm25: number): Record<string, any> {
  let color = "red";
  switch (true) {
